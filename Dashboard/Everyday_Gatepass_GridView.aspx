<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Everyday_Gatepass_GridView.aspx.cs" Inherits="ERP_Login.Dashboard.Everyday_Gatepass_GridView" %>
    ...
    <form id="form1" runat="server">
        <div class="container">
            <div class="card">
                ...
                <hr>
                <div>
                    <asp:GridView ID="GridView1" runat="server" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" DataKeyNames="Sl_no" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" OnRowDeleting="GridView1_RowDeleting" OnRowCancelingEdit="GridView1_RowCancelingEdit">
                        <Columns>
                            <asp:CommandField ShowEditButton="True" ButtonType="Button">
                                <ControlStyle BackColor="#3366FF" ForeColor="White"></ControlStyle>
                            </asp:CommandField>
