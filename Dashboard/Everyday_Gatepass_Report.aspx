<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Everyday_Gatepass_Report.aspx.cs" Inherits="ERP_Login.Dashboard.Everyday_Gatepass_Report" %>
    ...
    <form id="form1" runat="server">
        <div class="container">
            <div class="card">
                ...
                <hr>
                <div>
                    <asp:GridView ID="GridView1" runat="server" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" OnRowDeleting="GridView1_RowDeleting" DataKeyNames="Id">
                        <Columns>
