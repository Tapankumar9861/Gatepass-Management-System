<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Gatepass_Item_Report.aspx.cs" Inherits="ERP_Login.Dashboard.Gatepass_Item_Report" %>
    ...
    <form id="form1" runat="server">
        <div class="container">
            <div class="card">
                ...
                <hr>
                <div>
                    <asp:GridView ID="GridView1" runat="server" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" DataKeyNames="Id" OnRowDeleting="GridView1_RowDeleting">
                        <Columns>
