...
{
    public partial class Gatepass_Item_Report : System.Web.UI.Page
    {
        ...
        {
            string query = "select * from Item_Gatepass_Report";
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            string query = "DELETE FROM Item_Gatepass_Report WHERE Id = '" + Id + "'";
            using (SqlCommand cmd = new SqlCommand(query, con))
            {
                con.Open();
                ...
                {
                    Response.Write("<script>alert('Data Not Delete Successfully')</script>");
                }
            }
        }
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(searchText))
            {
                ...
                string query = "SELECT * FROM Item_Gatepass_Report WHERE Id = @Id";
                using (SqlCommand cmd = new SqlCommand(query, con))
                {
        ...
        {
            Response.Redirect("Gatepass_Item_Report.aspx");
        }
