...
{
    public partial class Gatepass_Reg_Report : System.Web.UI.Page
    {
        ...
        {
            string query = "select * from Gatepass_Report";
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            string query = "DELETE FROM Gatepass_Report WHERE Id = '" + Id + "'";
            using (SqlCommand cmd = new SqlCommand(query,con))
            {
                con.Open() ;
        ...
        {
            Response.Redirect("Gatepass_Reg_Report.aspx");
        }
